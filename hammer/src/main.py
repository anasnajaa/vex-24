...
motor_11 = Motor(Ports.PORT11, GearSetting.RATIO_6_1, True) # left - top
motor_12 = Motor(Ports.PORT12, GearSetting.RATIO_6_1, True) # left - top
motor_13 = Motor(Ports.PORT13, GearSetting.RATIO_6_1, False) # left 
motor_14 = Motor(Ports.PORT14, GearSetting.RATIO_6_1, False) # left 


motor_01 = Motor(Ports.PORT1, GearSetting.RATIO_6_1, True) # right - top
motor_02 = Motor(Ports.PORT2, GearSetting.RATIO_6_1, True) # right - top
motor_03 = Motor(Ports.PORT3, GearSetting.RATIO_6_1, False) # right
motor_04 = Motor(Ports.PORT4, GearSetting.RATIO_6_1, False) # right
...
right_drive_1 = motor_11 
right_drive_2 = motor_12
right_drive_3 = motor_13
right_drive_4 = motor_14

left_drive_1 = motor_01
left_drive_2 = motor_02 
left_drive_3 = motor_03 
left_drive_4 = motor_04 

# lift_left = motor_13
# lift_right = motor_20

intake_roller = motor_05
...
def drive_task():
    ...
    while True:
        ...
        left_drive_4.spin(FORWARD, -drive_left, PERCENT)
        right_drive_4.spin(FORWARD, drive_right, PERCENT)
